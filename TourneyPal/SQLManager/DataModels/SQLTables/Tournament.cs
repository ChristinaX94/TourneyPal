...
namespace TourneyPal.SQLManager.DataModels.SQLTables
{
    ...
    {
        public List<TournamentRow>? rows { get; private set; }
        ...
        public class TournamentRow : ModelRow
        {
            ...
            public new Result loadRow(MySqlDataReader reader)
            {
                Result result = new Result();
                try
                {
                    ...
                    this.StartsAT = (DateTime)startsAT;
                    ...
                    this.URL = reader[nameof(URL)].ToString();
                    ...
                    this.RegistrationOpen = (bool)registrationOpen;
